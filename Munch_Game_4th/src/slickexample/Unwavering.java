...
class itemwin {
	...
	Image currentImage;
	Shape hitbox;
	Image antidote = new Image("res/exit.png");
...
public class Unwavering extends BasicGameState {
	...
	throws SlickException {
		...
		grassMap = new TiledMap("res/Hedgemaze.tmx");
		...
		SpriteSheet runningSS = new SpriteSheet(
				"res/knightanimesheet.png",64, 64, 0);
